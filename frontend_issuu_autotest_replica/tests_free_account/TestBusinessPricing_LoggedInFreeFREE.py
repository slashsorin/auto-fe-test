...
class TestBusinessPricing_LoggedInFreeFREE(SeleniumTestCase.SeleniumTestCase):
...
globals().update(make_platform_classes.make_platform_classes(TestBusinessPricing_LoggedInFreeFREE))
