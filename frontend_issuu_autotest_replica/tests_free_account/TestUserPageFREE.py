...
class TestUserPageFREE(SeleniumTestCase.SeleniumTestCase):
    ...
    def test_user_page(self):
        try:
            ...
            sel.click("id=subscribers-count")
            sel.wait_for_page_to_load("60000")
            sel.go_back()
            sel.wait_for_page_to_load("60000")
...
globals().update(make_platform_classes.make_platform_classes(TestUserPageFREE))
