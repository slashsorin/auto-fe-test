...
class TestCommentsReceivedFREE(SeleniumTestCase.SeleniumTestCase):

    def test_comments_received(self):
        try:
            sel = self.selenium
            sel.set_speed("500")
            sel.open("/FREEaccount/commentsreceived")
...
globals().update(make_platform_classes.make_platform_classes(TestCommentsReceivedFREE))
