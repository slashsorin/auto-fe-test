...
class TestHobbiesLeisure(SeleniumTestCase):
   
    
    def test_hobbies_leisure(self):
        try:
            sel = self.selenium
            sel.set_speed("3000")
            sel.open("/hobbies-leisure")
...
globals().update(make_platform_classes.make_platform_classes(TestHobbiesLeisure))
