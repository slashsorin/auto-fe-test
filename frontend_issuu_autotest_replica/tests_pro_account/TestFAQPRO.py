...
class TestFAQPRO(SeleniumTestCase.SeleniumTestCase):
    ...
    def test_f_a_q(self):
        try:
            ...
            self.failUnless(sel.is_element_present("xpath=//div[@class='page-wrapper']/div[2]/div[6]/div[1]"))
...
globals().update(make_platform_classes.make_platform_classes(TestFAQPRO))
