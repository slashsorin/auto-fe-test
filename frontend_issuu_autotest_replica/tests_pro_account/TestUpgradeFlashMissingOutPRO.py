...
class TestUpgradeFlashMissingOutPRO(SeleniumTestCase.SeleniumTestCase):
...
globals().update(make_platform_classes.make_platform_classes(TestUpgradeFlashMissingOutPRO))
