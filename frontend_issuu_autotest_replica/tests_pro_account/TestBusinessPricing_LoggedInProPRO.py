...
class TestBusinessPricing_LoggedInFreePRO(SeleniumTestCase.SeleniumTestCase):
...
globals().update(make_platform_classes.make_platform_classes(TestBusinessPricing_LoggedInFreePRO))
