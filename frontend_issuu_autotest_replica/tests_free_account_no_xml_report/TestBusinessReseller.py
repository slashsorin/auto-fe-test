...
class TestBusinessReseller(SeleniumTestCase.SeleniumTestCase):

    def test_business_reseller(self):
        try:
            sel = self.selenium
...
globals().update(make_platform_classes.make_platform_classes(TestBusinessReseller))