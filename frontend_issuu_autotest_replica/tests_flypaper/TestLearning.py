...
class TestLearning(SeleniumTestCase):
    ...
    def test_learning(self):
        try:
            ...
            self.failUnless(sel.is_element_present("xpath=/html/body/div/section/div/div/h3/a"))
...
globals().update(make_platform_classes.make_platform_classes(TestLearning))
