...
class TestNotifications(SeleniumTestCase):
    ...
    def test_notifications(self):
        try:
            sel = self.selenium
            sel.set_speed("1000")
            sel.open("https://issuu.com/signin?onLogin=http%3A%2F%2Fissuu.com%2Fhome%2Fsettings%2Fnotifications")
            ...
            sel.click("xpath=//form[@id='notifications']//label[.='On']")
	        sel.click("id=notify_digestEmail_true")
	        sel.click("xpath=//form[@id='notifications']//label[.='On']")
	        sel.click("id=notify_digestEmail_true")
	        sel.click("xpath=//form[@id='notifications']//label[.='Off']")
	        sel.check("id=notify_digestEmail_false")
	        sel.click("xpath=//form[@id='notifications']/fieldset[2]/div/div/div/label[2]")
	        sel.check("id=notify_myDocumentToStack_false")
	        sel.click("xpath=//form[@id='notifications']/fieldset[2]/div/div/div/label[1]")
	        sel.check("id=notify_myDocumentToStack_true")
	        sel.click("xpath=//form[@id='notifications']/fieldset[3]/div/div/div/label[2]")
	        sel.check("id=notify_followed_false")
	        sel.click("xpath=//form[@id='notifications']/fieldset[3]/div/div/div/label[1]")
	        sel.check("id=notify_followed_true")
	        sel.click("xpath=//form[@id='notifications']/fieldset[4]/div/div/div/label[2]")
	        sel.check("id=notify_newsletter_false")
	        sel.click("xpath=//form[@id='notifications']/fieldset[4]/div/div/div/label[1]")
