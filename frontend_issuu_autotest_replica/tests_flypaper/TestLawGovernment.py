...
class TestLawGovernment(SeleniumTestCase):
   
    
    def test_law_government(self):
        try:
            sel = self.selenium
            sel.set_speed("3000")
            sel.open("/law-government")
...
globals().update(make_platform_classes.make_platform_classes(TestLawGovernment))
