...
class TestReligionSelfhelp(SeleniumTestCase):
   
    
    def test_religion_selfhelp(self):
        try:
            sel = self.selenium
            sel.set_speed("3000")
            sel.open("/religion-selfhelp")
...
globals().update(make_platform_classes.make_platform_classes(TestReligionSelfhelp))
