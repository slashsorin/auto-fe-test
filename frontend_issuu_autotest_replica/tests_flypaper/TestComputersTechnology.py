...
class TestComputersTechnology(SeleniumTestCase):
   
    
    def test_computers_technology(self):
        try:
            sel = self.selenium
            sel.set_speed("3000")
            sel.open("/computers-technology")
...
globals().update(make_platform_classes.make_platform_classes(TestComputersTechnology))
